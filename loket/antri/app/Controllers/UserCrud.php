    ...
    public function print($id = null)
    {
     ...
     //bagian 2
        ...
        public function store1() {
            ...
            return $this->response->redirect('/loket/antri/public/user-list1');
        }
        // show single user
        ...
        public function update1(){
            ...
            return $this->response->redirect('/loket/antri/public/users-list1');
        }
     
        // delete user
        public function delete1($id1 = null){
            $userModel1 = new UserModel();
            $data1['user1'] = $userModel1->where('id', $id1)->delete($id1);
            return $this->response->redirect('/loket/antri/public/users-list1');
        }    
